...
import ntnu.khoo.patterns.token.EmptyToken;
import ntnu.khoo.patterns.token.LiteralToken;
import ntnu.khoo.patterns.token.OneWordToken;
import ntnu.khoo.patterns.token.POSTagToken;
import ntnu.khoo.patterns.token.PhraseToken;
import ntnu.khoo.patterns.token.SlotToken;
import ntnu.khoo.patterns.token.SubpatternGroup;
import ntnu.khoo.patterns.token.Token;
import ntnu.khoo.patterns.token.VerbGroupToken;
...
public class PatternFactory {
	...
	public SubpatternGroup createSubpatternGroup(String value) throws Exception { 
        ...
        return new SubpatternGroup(value, subpatterns);
	}
	
	public VerbGroupToken createVerbGroupToken(String value) throws Exception{
		String string = value;
		String tilda = "";
		if (string.endsWith("~")) {
